...
// $routes->add('halaman/detail/(:any)/(:num)', 'Halaman::halaman_detail/$1/$2'); //any adalah penerima segala karakter, num untuk angka, alpha untuk karakter. alphanum untuk menerima karakter dan angka
